 ...
 */
export const listOrders = async (params: ListOrdersParams, options?: RequestInit): Promise<OrderResponse[]> => {

  return customFetch<OrderResponse[]>(getListOrdersUrl(params),
  {
    ...options,
    method: 'GET'
...
export const updateOrderStatus = async (id: number,
    ...
    params: UpdateOrderStatusParams, options?: RequestInit): Promise<OrderResponse> => {

  return customFetch<OrderResponse>(getUpdateOrderStatusUrl(id,params),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateOrderStatusMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateOrderStatus>>, TError,{id: number;data: BodyType<UpdateStatusRequest>;params: UpdateOrderStatusParams}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateOrderStatus>>, TError,{id: number;data: BodyType<UpdateStatusRequest>;params: UpdateOrderStatusParams}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateOrderStatus>>, {id: number;data: BodyType<UpdateStatusRequest>;params: UpdateOrderStatusParams}> = (props) => {
...
export const useUpdateOrderStatus = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateOrderStatus>>, TError,{id: number;data: BodyType<UpdateStatusRequest>;params: UpdateOrderStatusParams}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {id: number;data: BodyType<UpdateStatusRequest>;params: UpdateOrderStatusParams},
        TContext
      > => {
